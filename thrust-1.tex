...
Performs differential binary analysis across compiler passes, optimization levels, and target ISAs to attribute enlargements of the glitching attack surface to specific compiler transformations.
...
Defines and validates a quantitative surface metric (e.g., exploitable single-fault sites per function) enabling reproducible comparison across compilers, optimization levels, and ISAs.
\noindent\textbf{Goal.} % TODO(glitching)
