...
\textbf{Embedded Systems CTF Platform and Challenges.}
Existing CTF platforms, including pwn.college~\cite{PwnCollege}, OverTheWire~\cite{OverTheWire},
lack the architectural support and challenges for embedded systems.
They are designed for the Intel x86/64 architecture only.
The PIs are developing and will host \ctfplatform,
a next generation and open CTF platform that supports challenges for embedded systems.
In particular, the PIs will develop control-flow hijacking and attack mitigation challenges for embedded systems, e.g., buffer overflow, heap exploitation.
...
PI Zhao publicizes his course recordings, talks, and training recordings at the \emph{CactiLab} YouTube channel~\cite{youtubelist},
which has 670+ subscribers, 40,700+ views, and 4,300+ watch-time hours at the time of submitting this proposal.
...
\textbf{Outreach by PI Tan.}
\TODO{Describe PI Tan's outreach and broadening-participation activities at UCCS, especially her role as a mentor at the CyberTruck Challenge (hands-on heavy-vehicle/embedded cybersecurity training for students), and how she will bring \sysname results and glitching/fault-injection challenges into UCCS courses and CTF mentoring.}
\ul{Evaluation Plan:} \TODO{e.g., number of students mentored at the CyberTruck Challenge and their outcomes.}

\textbf{Economic/Societal Impacts and Technology Transfer}. 
Embedded and IoT devices are omnipresent.
...
The research activities will fundamentally influence the way embedded systems security solutions are built and used.
...
\begin{wrapfigure}{r}{0.45\textwidth}  
     ...
     \begin{subfigure}[b]{\linewidth}
         \centering
         \includegraphics[width=\linewidth]{MITREectf2023.png}
         \caption{4th in MITRE eCTF'23}
         \label{fig:rank}
     \end{subfigure}
     \begin{subfigure}[b]{\linewidth}
         \centering
         \includegraphics[width=\linewidth]{ectf.png}
     ...
     \vspace{-.35cm}      
        ...
        \vspace{-.35cm} 
\end{wrapfigure}
\textbf{Cybersecurity Training and CTF Teams with Undergraduate and High School Students.}
...
Team \emph{Cacti} has competed in the MITRE embedded CTF (eCTF) every year from 2019 through 2026, consistently placing in the top ten (as shown in Figure~\ref{fig:rank} and Figure~\ref{fig:presentation}).
...
PI Zhao's high school advisee Puhabi Chakraborti was conferred the Pradhan award by the Prime Minister Modi of India in 2022~\cite{puhabi2022} and received full scholarship to attend University at Buffalo in 2024.
\ul{Evaluation Plan:} 
...
The research experience with undergraduate and high school students will be evaluated by publications.
