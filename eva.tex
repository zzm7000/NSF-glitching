...
We will evaluate \sysname on a testbed of real MCU targets driven by a programmable voltage-glitching rig \TODO{name targets/equipment, e.g., ChipWhisperer + STM32/nRF/ESP boards}, using both standard embedded benchmarks and real-world firmware \TODO{name benchmark suites / firmware corpus}.
