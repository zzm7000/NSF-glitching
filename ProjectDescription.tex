...
Collaborative Research: SaTC 2.0: RES: \sysname: Characterizing, Finding, and Reducing Compiler-Introduced Glitching Vulnerabilities}}
\end{center}
...
\ul{Intellectual Merit:} TODO.
\ul{Broader Impacts:} TODO.
\ul{Research Outcome:} TODO (add citation).

PI Tan (UCCS): % TODO(glitching): list PI Xi Tan's prior/current NSF support (award #, amount, period, IM/BI, one outcome with citation). If she has received no prior NSF support, state: "PI Tan has not received prior NSF support."
